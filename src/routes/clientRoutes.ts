...
router.get('/', authMiddleware, authorizeRole("admin"), ClientController.listClients);
router.get('/:id', authMiddleware, authorizeRole("admin"), validateUUID, ClientController.getClient);
